...
String pav;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            ...
            case R.id.log_out:
                ...
                startActivity(new Intent(Feedback.this, Login_Citizen.class));
                finish();
    ...
    private void Upload() {
        ...
        Call<ResponseBody> call = service.Feedback("http://52.11.160.94/reports/inc/forms/feedback.php",User, DES, l1, h1, r1, v1);
