...
public class LetsRate extends BaseActivity implements AdapterView.OnItemSelectedListener {
   ...
   // CircularProgressView progressView;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            ...
            case R.id.log_out:
                ...
                startActivity(new Intent(LetsRate.this, Login_Citizen.class));
                finish();
    ...
    private void rateYouNow(String a,float p1, float q1, float r1,float s1) {
        ...
        Call<ResponseBody> call = service.CommunityRating("http://52.11.160.94/reports/inc/forms/area_feedback.php",User,ar,c1, m1,n1,o1,l1);
