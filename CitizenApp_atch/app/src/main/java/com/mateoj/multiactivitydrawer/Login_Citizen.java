...
public class Login_Citizen extends AppCompatActivity {
    ...
    Button _loginButton,women_Comp;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login__citizen);


        SharedPreferences settings = getSharedPreferences(PREFS_NAME, 0);
        if (settings.getString("logged", "").equals("logged")) {

            Intent intent = new Intent(Login_Citizen.this, MainActivity.class);
        ...
        women_Comp = (Button) findViewById(R.id.women_comp);
        ...
        women_Comp.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                startActivity(new Intent(Login_Citizen.this, NoHamburger.class));
            }
        });
        ...
        _signupLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Register_Citizen.class);
...
*/
        ...
        sb.append("user=").append(_emailPh.getText());
        sb.append("&password=").append(_passwordText.getText());
...
try {
    ...
    String naveen = response1.body().getUserID();
                    ...
                    if(pavan.equals("1")){
                        ...
                        startActivity(new Intent(Login_Citizen.this, MainActivity.class));
                        finish();
