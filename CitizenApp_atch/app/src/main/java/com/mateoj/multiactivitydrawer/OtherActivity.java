...
public class OtherActivity extends BaseActivity implements AdapterView.OnItemSelectedListener {
    ...
    String imgDecodableString, item, message;
        ...
        switch (id)
        {
            ...
            case R.id.log_out:
               // startActivity(new Intent(this, MainActivity.class));
                ...
                startActivity(new Intent(OtherActivity.this, Login_Citizen.class));
                finish();
            ...
            case R.id.info :
                startActivity(new Intent(this, InfoRep.class));
                return true;
            ...
            case R.id.Emer:
                ...
                Intent intent = new Intent(this, Static_Contacts.class);
            ...
            case R.id.Pol:
                ...
                Intent intent1 = new Intent(this, Static_Contacts.class);
    ...
    private void uploadFile(File multi) {
     ...
     //   RequestBody NAM = createPartFromString(String.valueOf(name.getText()));
        ...
        if (satish != null){
            ...
            call = service.TestReport("http://52.11.160.94/reports/inc/forms/live_updates_form.php",User,Emergency,IncidentType, DES, LAT, LNG,GAL);
    }

        else{

            call = service.onlyText("http://52.11.160.94/reports/inc/forms/live_updates_form.php",User,Emergency,IncidentType, DES,LAT,LNG);
